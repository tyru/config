...
"   0.0.8: fix some problems about multi-line. and insert at tail of current line when '\c$'.
"
" Usage:
"   COMMANDS:
"     CSOnelineComment
...
"         and also this value is used by '\cc'.
"
...
"
"     TODO: g:cs_multiline_insert (default:1)
"         NOTE: WRITE THIS LATER.
"
"     TODO: g:cs_zero_insert_if_blank (default:0)
"         NOTE: WRITE THIS LATER.
"
"     TODO: g:cs_tilda_insert_if_blank (default:0)
"         NOTE: WRITE THIS LATER.
"
"     TODO: g:cs_dollar_insert (default:1)
"         NOTE: WRITE THIS LATER.
"
...
"
"     TODO: g:cs_oneline_priority (default:[0, 1])
"         If g:cs_no_filetype_support is true, force to get this '[0]'.
"         NOTE: WRITE THIS LATER.
"
"     TODO: g:cs_multiline_priority (default:[0, 1])
"         If g:cs_no_filetype_support is true, force to get this '[0]'.
"         NOTE: WRITE THIS LATER.
"
"     
"
"   TODO:
"     * align comment when <SID>Comment( '0' ) or <SID>Comment( '$' )
...
if exists( 'g:cs_multiline_priority' )
    if type( g:cs_multiline_priority ) != type( [] ) || len( g:cs_multiline_priority ) != 2
        ...
        let g:cs_multiline_priority = [ 0, 1 ]
    endif
else
    let g:cs_multiline_priority = [ 0, 1 ]
endif
