...
"
"     XXX: cs_wrap_read_indent (default:1)
...
"
"     TODO: cs_wrap_enter_i (default:1)
...
func! <SID>InsertCommentFromMap( pos )
    let [fcomment, bcomment; unko] = s:CommentAnyWay.OneLine.GetCmtDef()
...
func! s:CommentAnyWay.MultiLine.BuildComments()
    ...
    " some checks.
    if g:cs_verbose && empty( result_lis )
